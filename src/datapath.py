...
class DataPath:
    ...
    def get_reg_idx(self, reg_name: str) -> int:                # Превращает имя регистра в индекс 0..15
        return int(reg_name.replace("R", ""))

    def read_reg(self, reg_name: str) -> int:                   # Возвращает 32-битное значение из регистра
